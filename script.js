...
// URL base de la API
const API_BASE_URL = 'https://pdvxiaomi-production.up.railway.app:8888/api/Xiaomi/pdv';
...
function initializeFuse() {
    const options = {
        keys: ['SAP', 'PDV', 'CIUDAD', 'REGIONAL', 'CANAL', 'CEDENA', 'DIRECCION'],
        threshold: 0.3,
    };
            ...
            output += `
                <div class="result-item">
                    ...
                    <ul>
                        ...
                        <li><strong>Cadena:</strong> ${result.CEDENA || 'N/A'}</li>
                    </ul>
                </div>
            `;
        });
